...
${OBJECTDIR}/FoodNutrition.o: FoodNutrition.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FoodNutrition.o FoodNutrition.cpp

${OBJECTDIR}/FoodNutritionManagement.o: FoodNutritionManagement.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FoodNutritionManagement.o FoodNutritionManagement.cpp
...
${OBJECTDIR}/UserProfile.o: UserProfile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UserProfile.o UserProfile.cpp

${OBJECTDIR}/UserProfileManagement.o: UserProfileManagement.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UserProfileManagement.o UserProfileManagement.cpp
...
${TESTDIR}/tests/ExerciseTrackingTest.o: tests/ExerciseTrackingTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ExerciseTrackingTest.o tests/ExerciseTrackingTest.cpp


${TESTDIR}/MealTest.o: MealTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/MealTest.o MealTest.cpp


${TESTDIR}/UserProfileManagementTest.o: UserProfileManagementTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/UserProfileManagementTest.o UserProfileManagementTest.cpp
...
${OBJECTDIR}/FoodNutrition_nomain.o: ${OBJECTDIR}/FoodNutrition.o FoodNutrition.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FoodNutrition_nomain.o FoodNutrition.cpp;\
	else  \
...
${OBJECTDIR}/FoodNutritionManagement_nomain.o: ${OBJECTDIR}/FoodNutritionManagement.o FoodNutritionManagement.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FoodNutritionManagement_nomain.o FoodNutritionManagement.cpp;\
	else  \
...
${OBJECTDIR}/UserProfile_nomain.o: ${OBJECTDIR}/UserProfile.o UserProfile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UserProfile_nomain.o UserProfile.cpp;\
	else  \
...
${OBJECTDIR}/UserProfileManagement_nomain.o: ${OBJECTDIR}/UserProfileManagement.o UserProfileManagement.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UserProfileManagement_nomain.o UserProfileManagement.cpp;\
	else  \
